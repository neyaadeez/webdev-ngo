...
if(Validate($F_Name, $L_Name, $Email, $Contact_no, $Address)==true){
  ...
  $insert_animal = "INSERT INTO `ngo`.`animal` (`Type`, `Fur_color`, `A_Gender`, `Breed`, `P_Id`, `Adopt_date`, `Date_found`, `Area_found`, `Area_Pin`) VALUES ('$Type', '$Fur_color',' $A_Gender', '$Breed', '$P_Id', NULL, '$Date_found', '$Area_found', '$Area_Pin');";
...
<div class="container6">
  ...
  <ul class="nav nav-tabs" id=tab>
    <li class="nav-item">
      <a class="nav-link active"href="form.php">Report Lost animal</a>
    </li>
    <li class="nav-item">
    ...
    <article class="name">
    Report Lost/Abandoned animal
  </article> <br>

  <form name="form1" class="row g-3"  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" onsubmit="">
  <div class="col-md-6">
 ...
 <label for="inputEmail4" class="form-label">Email</label>
  ...
  <div class="col-4">
      <label for="inputfur" class="form-label">Date Found</label>
      <input type="date" class="form-control" id="Date_found" name="Date_found" required>
    </div>
  <div class="col-4">
      <label for="inputfur" class="form-label">Area Found</label>
      <input type="text" class="form-control" id="Area_found" name="Area_found" required>
    </div>
  <div class="col-4">
      <label for="inputfur" class="form-label">Area Pin</label>
      <input type="number" class="form-control" id="Area_Pin" name="Area_Pin">
    </div>
  <div class="col-3">
    ...
    <div class="col-md-4">
    <label for="animal" class="form-label">Animal Type</label>
    <select id="animal" class="form-select" name="Type">
